    ...
    <nav class="navbar fixed-top">
        ...
        <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
            ...
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                ...
                <!-- End Notifications -->
                <!-- User -->
                <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="@if (Auth::user()->metadata['photo'] == null){{ asset('assets/img/avatar/avatar-01.jpg') }}@else{{ asset('images/profile') . '/' . Auth::user()->metadata['photo'] }} @endif" alt="..." class="avatar rounded-circle"></a>
                    <ul aria-labelledby="user" class="user-size dropdown-menu">
                        <li class="welcome">
                            <a href="#" class="edit-profil"><i class="la la-gear"></i></a>
                            <img src="@if (Auth::user()->metadata['photo'] == null){{ asset('assets/img/avatar/avatar-01.jpg') }}@else{{ asset('images/profile') . '/' . Auth::user()->metadata['photo'] }}@endif" alt="..."
                        ...
                        <li><a rel="nofollow" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="dropdown-item logout text-center"><i class="ti-power-off"></i></a></li>
                    </ul>
                </li>
            </ul>
            <!-- End Navbar Menu -->
