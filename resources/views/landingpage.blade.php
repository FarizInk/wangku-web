...
<head>
    ...
    <title>Wangku - Coming Soon</title>
    <meta name="description" content="Application to manage your finances.">
...
<body class="bg-fixed-04">
    ...
    <!-- End Page Vendor Js -->
    <!-- Begin Page Snippets -->
    <script src="{{ asset('assets/js/pages/coming-soon.min.js') }}"></script>
    <!-- End Page Snippets -->
</body>
